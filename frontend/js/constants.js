const contractAddress = "0x0BF5d45DF5F474595B1e0eD637089Ebbe7d1a2E3"; //Replace with your own contract address
const chain = 'rinkeby'; // rinkeby or polygon

const welcome_h1 = "Welcome to the PlanetCapsules NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The PlanetCapsules NFT Project is a decentralized, open-source project.';
